...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('org_name', 'Organization Name'), ('org_description', 'Organization Description'), ('org_url', 'Organization URL'), ('org_theme_color', 'Organization Theme Color'), ('org_author', 'Organization Author'), ('org_author_url', 'Organization Author URL')], max_length=25, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(help_text='Image file for logos, favicons, etc.', upload_to='home/org')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
