    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('base_name', 'Name'), ('base_description', 'Motto / Description'), ('base_theme_color', 'Theme Color'), ('base_url', 'Website URL'), ('base_author', "Author's Name"), ('base_author_url', "Author's Website URL")], max_length=25, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='Image file for logos, favicons, etc.', null=True, upload_to='core/base')),
            ],
            options={
                'ordering': ['ordering'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff_role', models.BooleanField(default=False, help_text='Users with this role can log into this admin site.')),
