...
class LandingURLRegistry:
    ...
    def register_landing_url(self, url_name, app_name):
        ...
        if self._registered:
            logger.warning(
                f"Home URL already registered by '{self._landing_app}' as '{self._landing_url_name}'. "
    ...
    def get_landing_url(self):
        ...
        try:
            ...
            raise ImproperlyConfigured(
                f"Could not reverse home URL '{self._landing_url_name}' "
...
if __name__ == "__main__":
    ...
    from base.home import register_landing_url
    ...
    from base.home import get_landing_url
    ...
    from base.home import get_landing_url_name
